...
export class Camera {
  ...
  reset(preset=0){this.target=[0,0,0];this.yaw=.24;this.pitch=preset===3?.12:preset===4?.18:.42;this.distance=preset===3?25:preset===4?30:22;this.fov=Math.PI/3.2;this.update(1);}
  update(aspect){
